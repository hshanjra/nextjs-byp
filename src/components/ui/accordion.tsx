  ...
  <AccordionPrimitive.Header className="flex">
    ...
    >
      ...
      <>
        <MinusIcon
          size={14}
          className="shrink-0 text-black transition-transform duration-200 group-data-[state=closed]:hidden"
        />
        <PlusIcon
          size={14}
          className="shrink-0 text-black transition-transform duration-200 group-data-[state=open]:hidden"
        />
      </>
    </AccordionPrimitive.Trigger>
  </AccordionPrimitive.Header>
